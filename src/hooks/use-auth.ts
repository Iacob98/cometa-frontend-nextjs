...
export function usePermissions() {
  ...
  return {
    ...
    isBauleiter: hasRole("bauleiter"),
    isForeman: hasRole("foreman"),
    isWorker: hasAnyRole(["crew", "worker"]),
    isViewer: hasRole("viewer"),
    canManageProjects: hasAnyRole(["admin", "pm", "bauleiter"]),
    canManageTeams: hasAnyRole(["admin", "pm", "bauleiter", "foreman"]),
    canApproveWork: hasAnyRole(["admin", "pm", "bauleiter", "foreman"]),
    canManageWork: hasAnyRole(["admin", "pm", "bauleiter", "foreman", "crew", "worker"]),
    canViewFinances: hasAnyRole(["admin", "pm", "bauleiter", "foreman"]),
    canManageFinances: hasAnyRole(["admin", "pm", "bauleiter"]),
    canManageInventory: hasAnyRole(["admin", "pm", "bauleiter", "foreman"]),
  };
}
