...
export function getActivityTypeLabel(type: string): string {
  const labels: Record<string, string> = {
    ...
    work_entry_created: 'Запись о работе создана',
    work_entry_updated: 'Запись о работе обновлена',
    work_entry_approved: 'Запись о работе одобрена',
    work_entry_deleted: 'Запись о работе удалена',
    crew_created: 'Бригада создана',
    crew_updated: 'Бригада обновлена',
    crew_deleted: 'Бригада удалена',
    user_created: 'Пользователь создан',
    user_updated: 'Пользователь обновлён',
    user_deleted: 'Пользователь удалён',
    equipment_created: 'Оборудование добавлено',
    equipment_updated: 'Оборудование обновлено',
    equipment_deleted: 'Оборудование удалено',
    equipment_assigned: 'Оборудование назначено',
    material_allocated: 'Материал распределён',
    material_used: 'Материал использован',
