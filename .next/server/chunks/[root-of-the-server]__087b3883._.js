module.exports = [
"[project]/.next-internal/server/app/api/resources/vehicle-assignments/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/resources/vehicle-assignments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
      ...
      `);
        ...
        const { data: assignments, error } = await query.order("from_ts", {
            ascending: false
        });
        if (error) {
...
async function POST(request) {
    try {
        ...
        const { data: existingAssignments, error: checkError } = await supabase.from("vehicle_assignments").select("id, crew_id").eq("vehicle_id", body.vehicle_id).eq("is_active", true);
        if (checkError) {
...
async function PUT(request) {
    try {
        ...
        const { data: updatedAssignment, error } = await supabase.from("vehicle_assignments").update({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__087b3883._.js.map