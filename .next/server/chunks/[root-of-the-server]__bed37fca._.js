module.exports = [
"[project]/.next-internal/server/app/api/geo-routes/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/geo-routes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let query = supabase.from("geo_routes").select(`
        id,
        name,
        description,
        waypoints,
      ...
      `);
        ...
        const { data: routes, error } = await query.order("created_at", {
            ascending: false
        });
        if (error) {
...
async function POST(request) {
    try {
        ...
        const routeData = {
            ...
            estimated_duration_minutes: body.estimated_duration_minutes || Math.round(totalDistance / 83.33),
            route_type: body.route_type || "walking",
            project_id: body.project_id || null,
            created_by: body.created_by || "system"
        };
        const { data: route, error } = await supabase.from("geo_routes").insert([
            routeData
        ]).select().single();
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bed37fca._.js.map