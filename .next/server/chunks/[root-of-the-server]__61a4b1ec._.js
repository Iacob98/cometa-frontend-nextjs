...
async function GET(request) {
    try {
      ...
      `, {
        ...
        if (search) {
            query = query.or(`name.ilike.%${search}%,inventory_no.ilike.%${search}%,type.ilike.%${search}%,description.ilike.%${search}%`);
        }
...
async function POST(request) {
    try {
        ...
        const { type, name, inventory_no, status = "available", rental_cost_per_day, description, owned = true, purchase_price_eur, rental_price_per_day_eur, rental_price_per_hour_eur, current_location } = body;
        // Validation
        if (!type || !name) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
      ...
      `).single();
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(equipment, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__61a4b1ec._.js.map