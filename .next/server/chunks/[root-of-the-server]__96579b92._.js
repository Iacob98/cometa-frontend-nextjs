module.exports = [
"[project]/.next-internal/server/app/api/suppliers/[id]/materials/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/suppliers/[id]/materials/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { data: supplierMaterials, error } = await supabaseService.from("supplier_materials").select(`
        id,
        supplier_id,
        material_id,
      ...
      `).eq("supplier_id", id).order("created_at", {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(formattedMaterials);
    } catch (error) {
...
async function POST(request, { params }) {
    try {
        ...
        const { material_id, material_name, category, unit, supplier_part_number, unit_price, minimum_order_qty = 1, lead_time_days, is_preferred = false, notes } = body;
        ...
        if (material_name) {
            const { data: newMaterial, error: materialError } = await supabaseService.from("materials").insert({
                name: material_name,
        ...
        const { data: existing } = await supabaseService.from("supplier_materials").select("id").eq("supplier_id", id).eq("material_id", finalMaterialId).single();
        if (existing) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const { data: supplierMaterial, error } = await supabaseService.from("supplier_materials").insert({
            supplier_id: id,
      ...
      `).single();
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(formattedMaterial, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__96579b92._.js.map