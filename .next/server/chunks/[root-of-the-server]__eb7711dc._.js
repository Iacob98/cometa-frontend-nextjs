module.exports = [
"[project]/.next-internal/server/app/api/materials/[id]/transactions/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/materials/[id]/transactions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        try {
            ...
            const { data: transactions, error } = await supabaseService.from('material_transactions').select(`
          id,
          transaction_type,
          quantity,
          unit_price,
          ...
          created_at,
          updated_at
        `).eq('material_id', id).order('created_at', {
                ascending: false
            });
            if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb7711dc._.js.map