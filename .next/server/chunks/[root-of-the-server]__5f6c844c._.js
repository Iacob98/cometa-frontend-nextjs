module.exports = [
"[project]/.next-internal/server/app/api/suppliers/[id]/contacts/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/suppliers/[id]/contacts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { data: contacts, error } = await supabaseService.from("supplier_contacts").select(`
        id,
        supplier_id,
        name,
        position,
        ...
        created_at,
        updated_at
      `).eq("supplier_id", id).order("is_primary", {
            ascending: false
        }).order("name", {
            ascending: true
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(contactsWithCompatibility);
    } catch (error) {
...
async function POST(request, { params }) {
    try {
        ...
        const { contact_name, name, position, department, phone, email, is_primary = false, notes } = body;
        ...
        if (is_primary) {
            await supabaseService.from("supplier_contacts").update({
                is_primary: false
            }).eq("supplier_id", id);
        }
        // Create contact in Supabase using service role to bypass RLS
        const { data: contact, error } = await supabaseService.from("supplier_contacts").insert({
            supplier_id: id,
            name: contactName,
      ...
      `).single();
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(contactWithCompatibility, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5f6c844c._.js.map