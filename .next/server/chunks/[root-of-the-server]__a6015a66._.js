module.exports = [
"[project]/.next-internal/server/app/api/teams/crews/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/teams/crews/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { data: crew, error } = await supabase.from('crews').select(`
        id,
        name,
        description,
        status,
      ...
      `).eq('id', id).eq('crew_members.is_active', true).single();
        if (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(formattedCrew);
    } catch (error) {
...
async function PUT(request, { params }) {
    try {
        ...
        // Update the crew
        const { data: crew, error } = await supabase.from('crews').update(updateData).eq('id', id).select(`
        id,
        name,
        description,
        status,
...
async function DELETE(request, { params }) {
    try {
        ...
        const { data: existingCrew, error: checkError } = await supabase.from('crews').select('id, name').eq('id', id).single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a6015a66._.js.map