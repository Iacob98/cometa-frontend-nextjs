module.exports = [
"[project]/.next-internal/server/app/api/geo-measurements/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/geo-measurements/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let query = supabase.from("geo_measurements").select(`
        id,
        measurement_type,
        geometry,
        value,
      ...
      `);
        ...
        const { data: measurements, error } = await query.order("measured_at", {
            ascending: false
        });
        if (error) {
...
async function POST(request) {
    try {
        ...
        const { data: measurement, error } = await supabase.from("geo_measurements").insert([
            measurementData
        ]).select().single();
        if (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(measurement, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a706b0c._.js.map