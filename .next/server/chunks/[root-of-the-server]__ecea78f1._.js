module.exports = [
"[project]/.next-internal/server/app/api/project-preparation/utility-contacts/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/project-preparation/utility-contacts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data: contacts, error } = await supabase.from('utility_contacts').select(`
        id,
        kind,
        organization,
        contact_person,
...
async function POST(request) {
    try {
        ...
        const { data: contact, error } = await supabase.from('utility_contacts').insert({
            project_id,
            kind,
            organization,
            contact_person,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ecea78f1._.js.map