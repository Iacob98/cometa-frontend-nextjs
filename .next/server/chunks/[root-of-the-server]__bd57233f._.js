module.exports = [
"[project]/.next-internal/server/app/api/materials/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function GET(request) {
    try {
      ...
      `, {
        ...
        if (search) {
            query = query.or(`name.ilike.%${search}%,category.ilike.%${search}%,supplier_name.ilike.%${search}%,description.ilike.%${search}%`);
        }
...
async function POST(request) {
    try {
        ...
        const { name, category, unit = "pcs", unit_price_eur = 0, supplier_name, description, is_active = true } = body;
        // Validation
        if (!name) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
      ...
      `).single();
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(transformedMaterial, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bd57233f._.js.map